  ...
  return (
    ...
    <form>
        <div className="mb-3">
            ...
            <input type="text" className="form-control" id="fullNameInputEmail1" aria-describedby="emailHelp"/>
        </div>
        <div className="mb-3">
            <label htmlFor="idNumInputEmail1" className="form-label">ID Number</label>
            <input type="text" className="form-control" id="idNumInputEmail1" aria-describedby="emailHelp"/>
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
            ...
            <input type="email" className="form-control" id="emailInputEmail1" aria-describedby="emailHelp"/>
        </div>
        <div className="mb-3">
            <label htmlFor="occupationInputPassword1" className="form-label">Occupation</label>
            <input type="text" className="form-control" id="occupationInputPassword1"/>
        </div>
        ...
        <div className="mb-3">
            ...
            <input type="datetime-local" className="form-control" id="leaseInputPassword1"/>
        </div>
